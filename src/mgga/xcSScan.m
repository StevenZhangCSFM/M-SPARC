...
[p_up, alpha_up, DpDn_up, DpDDn_up, DalphaDn_up, DalphaDDn_up, DalphaDtau_up] ...
    = ex_basicr2SCANvariables(2*rho(:, 2), 2*normDrho(:, 2), 2*tau(:, 2));
[ex_up, Vx1_up, Vx2_up, Vx3_up] = exchanger2SCAN(2*rho(:, 2), p_up, alpha_up, DpDn_up, DpDDn_up, DalphaDn_up, DalphaDDn_up, DalphaDtau_up);
[p_dn, alpha_dn, DpDn_dn, DpDDn_dn, DalphaDn_dn, DalphaDDn_dn, DalphaDtau_dn] ...
    = ex_basicr2SCANvariables(2*rho(:, 3), 2*normDrho(:, 3), 2*tau(:, 3));
[ex_dn, Vx1_dn, Vx2_dn, Vx3_dn] = exchanger2SCAN(2*rho(:, 3), p_dn, alpha_dn, DpDn_dn, DpDDn_dn, DalphaDn_dn, DalphaDDn_dn, DalphaDtau_dn);
...
[ec, Vc1, Vc2, Vc3] = correlationSr2SCAN(rho(:, 1), s, p, alpha, zeta, DsDn, DsDDn, DpDn, DpDDn, DalphaDnup, DalphaDndn, DalphaDDn, DalphaDtau, DzetaDnup, DzetaDndn);
